% Adapted from https://www.mathworks.com/matlabcentral/fileexchange/46105-adjust-legend-marker-size
...
[l1,l2,l3,l4]=legend(legstrings,'fontsize', legfontsize, 'location', legloc,'Interpreter', 'latex');
legend boxoff
